...
public class OnDiskGraphIndexWriterForLucene implements Closeable {
    ...
    private OnDiskGraphIndexWriterForLucene(RandomAccessWriter out,
                                   int version,
                                   long startOffset,
                                   GraphIndex graph,
    ...
    public static class Builder {
        ...
        public OnDiskGraphIndexWriterForLucene.Builder withVersion(int version) {
        ...
        public OnDiskGraphIndexWriterForLucene.Builder with(Feature feature) {
            features.put(feature.id(), feature);
            return this;
        }

        public OnDiskGraphIndexWriterForLucene.Builder withMapper(OrdinalMapper ordinalMapper) {
         ...
         */
        public OnDiskGraphIndexWriterForLucene.Builder withStartOffset(long startOffset) {
            this.startOffset = startOffset;
            return this;
        }

        public OnDiskGraphIndexWriterForLucene build() throws IOException {
            ...
            return new OnDiskGraphIndexWriterForLucene(out, version, startOffset, graphIndex, ordinalMapper, dimension, features);
        }

        public OnDiskGraphIndexWriterForLucene.Builder withMap(Map<Integer, Integer> oldToNewOrdinals) {
